...
// //       onClick={handleNext}
// //       disabled={!formik.values.email || emailError}
// //     >
// //       NEXT
// //     </Button>
// //   </Box>
...
// //   <Box mt={4} textAlign="center">
// //     <Typography variant="h5" fontWeight="bold">SIGN UP</Typography>
// //     <Typography variant="body1" mt={2}>6-digit PIN sent to {formik.values.email}</Typography>
...
// //     {/* {activeStep === 2 && (
// //     <Box mt={6} textAlign="center">
// //     <Typography variant="h5" fontWeight="bold">Personal Info</Typography>
...
//       setServerOtp(response.data.otp); // store OTP returned from backend
...
//             <Typography variant="body1" mt={2}>Enter the 6-digit OTP sent to {formik.values.email}</Typography>
...
//               <Button variant="contained" sx={{ backgroundColor: "#2B909B" }} onClick={handleNext}>
//                 NEXT
//               </Button>
//             </Box>
//           </Box>
...
//               <RadioGroup row value={idType} onChange={(e) => setIdType(e.target.value)} sx={{ mt: 2 }}>
//                 <FormControlLabel value="NIC" control={<Radio />} label="NIC" />
//                 <FormControlLabel value="Passport" control={<Radio />} label="Passport" />
//               </RadioGroup>
...
//               <Box display="flex" justifyContent="space-between" mt={3}>
//                 <Button variant="outlined" onClick={handleBack}>Back</Button>
//                 <Button variant="contained" type="submit" sx={{ backgroundColor: "#2B909B" }}>
    ...
    <Box sx={{ mt: 2, display: "flex", flexDirection: "column", alignItems: "center", minHeight: "100vh" }}>
      <Paper elevation={10} sx={{ p: 4, width: "40%", minWidth: "350px" }}>
        ...
        {activeStep === 1 && (
          <Box mt={4} textAlign="center">
            <Typography variant="h5" fontWeight="bold">Verify Email</Typography>
            <Typography variant="body1" mt={2}>Enter the OTP sent to {formik.values.email}</Typography>
        ...
        {activeStep === 2 && (
          <Box mt={4} textAlign="center">
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <TextField fullWidth label="First Name" name="firstName" value={formik.values.firstName} onChange={formik.handleChange} sx={{ mt: 2 }} />
              <TextField fullWidth label="Last Name" name="lastName" value={formik.values.lastName} onChange={formik.handleChange} sx={{ mt: 2 }} />
              ...
              <TextField fullWidth label={idType} name="nic" value={formik.values.nic} onChange={formik.handleChange} sx={{ mt: 2 }} />
